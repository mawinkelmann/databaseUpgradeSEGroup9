...
Co-Authors: Jason Pulis, Christopher Whetsel, Mike Winkelmann



Django settings for GLMMS project.
...
ALLOWED_HOSTS = ['django-env.yrrj9jxpmp.us-east-1.elasticbeanstalk.com','127.0.0.1']
...
WSGI_APPLICATION = 'GLMMS_main.wsgi.application'
