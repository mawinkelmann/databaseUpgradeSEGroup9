...
- Download the databaseUpgradeSEGroup9 repository by selecting the clone or downlod button at the top right of the main GitHub page and select download zip from the choices
- Unzip the file
